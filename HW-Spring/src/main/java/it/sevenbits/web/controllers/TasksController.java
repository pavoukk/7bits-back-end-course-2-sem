...
public class TasksController {
    ...
    @ResponseBody
    public ResponseEntity<List<Task>> getList(@RequestParam(value = "status", required = false, defaultValue = "inbox") String status) {
    ...
    @ResponseBody
    public ResponseEntity<Task> findTaskById(@PathVariable(value = "id") String id) throws TasksRepositoryException {
    ...
    @ResponseBody
    public ResponseEntity<?> updateTask(@PathVariable(value = "id") String id, @RequestBody @Valid UpdateTaskRequest taskRequest) throws TasksRepositoryException {
        if (!idValidator.check(id)) {
            return ResponseEntity
                    .notFound()
                    .build();
        ...
        Task newTask = new Task(old.getId(), old.getText(), taskRequest.getStatus());
    ...
    @ResponseBody
    public ResponseEntity<?> removeTask(@PathVariable(value = "id") String id) throws TasksRepositoryException {
        if (!idValidator.check(id)) {
            return ResponseEntity
                    .notFound()
                    .build();
